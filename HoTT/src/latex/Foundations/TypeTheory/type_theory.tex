...
\actualAxiom{$rule\_\lambda-form : \context{\Gamma} \vdash \var{A}:\U{i},\quad \context{\Gamma}, \var{x}:\var{A} \vdash \var{B}:\U{i}\ \text{——}\ \context{\Gamma} \vdash \var{A} \to \var{B}:\U{i}$} \probe
\end{axiom}
...
\actualAxiom{$rule\_\Pi-form : \context{\Gamma} \vdash \var{A}:\U{i},\quad \context{\Gamma}, \var{x}:\var{A} \vdash \var{B}:\U{i}\ \text{——}\ \context{\Gamma} \vdash \Pi_{\var{y}:\var{A}}\var{B}:\U{i}$} \probe
\end{axiom}
