...
\actualAxiom{$rule\_\Sigma-form : \context{\Gamma} \vdash \var{A}:\U{i},\quad \context{\Gamma}, \var{a}:\var{A} \vdash \var{B}:\U{i}\ \text{——}\ \context{\Gamma} \vdash \Sigma_{\var{x}:\var{A}}\var{B}(\var{x}):\U{i}$} \probe
\end{axiom}

\begin{axiom}{1.3.2}
\axiomName{Dependent pair introduction} \probe : 

\actualAxiom{$rule\_\Sigma-intro : \context{\Gamma}, \var{a}:\var{A} \vdash \var{B}:\U{i},\quad \context{\Gamma} \vdash \var{a}:\var{A},\quad \context{\Gamma} \vdash \var{b}:\var{B}(\var{x})\ \text{——}\ \context{\Gamma} \vdash pair(\var{a}, \var{b}):\Sigma_{\var{y}:\var{A}}\var{B}(\var{y})$} \probe
\end{axiom}

\begin{axiom}{1.3.3}
\axiomName{Dependent pair elimination} \probe : 

\actualAxiom{$rule\_\Sigma-elim : \context{\Gamma}, \var{z}:\Sigma_{\var{x}:\var{A}}\var{B}(\var{x}) \vdash \var{C}:\U{i},\quad \context{\Gamma}, \var{a}:\var{A},\var{b}:\var{B} \vdash \var{g}:\var{C}(pair(\var{a},\var{b})),\quad \context{\Gamma} \vdash \var{p}:\Sigma_{\var{y}:\var{A}}\var{B}(\var{y})\ \text{——} \context{\Gamma} \vdash ind(\var{C}(\var{z}), \var{g}, \var{p}):\var{C}(\var{z})$} \probe
\end{axiom}

\begin{axiom}{1.3.4} \axiomName{Dependent pair computation} \probe : 

\actualAxiom{$rule\_\Sigma-comp : \context{\Gamma}, \var{z}:\Sigma_{\var{x}:\var{A}}\var{B}(\var{x}) \vdash \var{C}:\U{i},\quad \context{\Gamma},\var{a}:\var{A},\var{b}:\var{B} \vdash \var{g}:\var{C}(\var{z}),\quad \context{\Gamma} \vdash \var{a}:\var{A},\quad \context{\Gamma} \vdash \var{b}:\var{B}(\var{x})\ \text{——}\ \context{\Gamma} \vdash \text{let}\ \var{x} = \var{a}, \var{y} = \var{b}, \var{z} = pair(\var{a},\var{b})\ \text{in}\ ind(\var{C}(\var{z}), \var{g}, pair(\var{a},\var{b}))\equiv \var{g}(\var{x}, \var{y}):\var{C}(\var{z})$} \probe
\end{axiom}
